// created in common JS because original zigar-laoder is in commonJS
// https://github.com/chung-leong/zigar/blob/main/zigar-loader/dist/index.js
// Do not rewrite it to anytign else, oterwise updatign this file with zigar-loader will be problematic

// the only change introduced by me is additional condition "sourcePath.includes('/private/var/folders')" 
// to avoid infinite loop of transpilation
...
async function loader(content, map, meta) {
  ...
  if (sourcePaths) {
    for (const sourcePath of sourcePaths) {
      if (sourcePath != path && !sourcePath.includes('/private/var/folders')) {
