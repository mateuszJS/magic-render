...
pub var pixel_density: f32 = 1.0; // Global pixel density (devicePixelRatio)
...
pub var is_test: bool = false; // whether it's test environment, used to disable some optimizations and enable some debug features
